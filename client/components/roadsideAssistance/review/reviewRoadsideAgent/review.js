...
class ReviewRoadsideAssistanceAgentHelper extends Component {
constructor(props) {
    super(props);
    ...
    renderConditional = () => {
        const { hospitality, safeDriving, respectful, quickResponses, informational, knowledgable, expectation, user } = this.state;
                ...
                <Fragment>
                    <View style={styles.margin}>
                        ...
                        <View style={[styles.row, { marginTop: 40 }]}>
                            ...
                            <TouchableOpacity onPress={() => {
                                this.setState({
                                    safeDriving: !this.state.safeDriving
                                })
                            }}>
                                <View style={styles.column}>
                                    <View style={safeDriving === true ? styles.darkCircle : styles.circle}>
                                        <Image source={require("../../../../assets/icons/towww.png")} style={styles.icon} />
                                    </View>
                                    <Text style={styles.textText}>Safe Driving</Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => {
                                this.setState({
                                ...
                                <View style={styles.column}>
                                    ...
                                    <Text style={styles.textText}>Driver was respectful</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                        <View style={[styles.row, { marginTop: 40 }]}>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <View style={styles.column}>
                                    ...
                                    <Text style={styles.textText}>Driver was knowledgable</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                        ...
                        <View style={{ marginTop: 15 }}>
                            ...
                            <AirbnbRating
                                ...
                                onFinishRating={(value) => {
                                    this.setState({
                                        proper_vehicle_condition_rating: value
                                    })
                                }}
                            />
                        </View>
