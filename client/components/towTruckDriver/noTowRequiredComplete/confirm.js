...
class NoTowConfirmOnSiteHelper extends Component {
constructor(props) {
    super(props);
    ...
    handleClientSubmission = () => {
        ...
        console.log("handleClientSubmission clicked....");

        axios.post(`${Config.ngrok_url}/complete/no-tow/roadside/assistance/job`, {
            id: this.props.unique_id,
    ...
    handleCompletionTowDriverAgent = () => {
        ...
        axios.post(`${Config.ngrok_url}/complete/no-tow/roadside/assistance/job/agent`, {
            id: this.props.unique_id,
...
export default connect(mapStateToProps, { })(NoTowConfirmOnSiteHelper);