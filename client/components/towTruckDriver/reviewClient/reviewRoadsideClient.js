    ...
    handleSubmission = () => {
        ...
        if (pickup_accurate_rating !== 0 && communication_rating !== 0 && informational_rating !== 0 && safe_during_interaction !== 0 && overall_interaction_rating !== 0 && honest_polite_rating !== 0 && as_described !== 0 && typeof expectation !== "undefined" && expectation.length > 0 && (typeof publicMessage !== "undefined" && publicMessage.length > 0)) {
            ...
            axios.post(`${Config.ngrok_url}/submit/feedback/review/client`, {
                ...
                helpful, 
                other_user_id: user.active_roadside_assistance_job.requestee_id,
                respectful, 
                quickResponses, 
                descriptive, 
                expectation, 
                        ...
                        <View style={[styles.row, { marginTop: 40 }]}>
                            <TouchableOpacity onPress={() => {
                                ...
                                <View style={styles.column}>
                                    ...
                                    <Text style={styles.textText}>Quick responses before & after trip</Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => {
                                this.setState({
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <View style={styles.column}>
                                    ...
                                    <Text style={styles.textText}>I felt safe with this client during the trip</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
...
export default connect(mapStateToProps, { })(ReviewRoadsideAssistanceClientHelper);